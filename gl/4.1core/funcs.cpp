...
void *gl4_1core_funcs() {
	QOpenGLFunctions_4_1_Core* funcs = QOpenGLVersionFunctionsFactory::get<QOpenGLFunctions_4_1_Core>(QOpenGLContext::currentContext());
	if (!funcs) {
		return 0;
	}
...
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(const GLubyte*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glIndexubv"));
	_f(c);
}
...
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLubyte);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glIndexub"));
	_f(c);
}
...
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glSecondaryColorP3uiv"));
	_f(gltype, color);
}
...
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glSecondaryColorP3ui"));
	_f(gltype, color);
}
...
void gl4_1core_glColorP4uiv(void *_glfuncs, GLenum gltype, const GLuint* color)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glColorP4uiv"));
	_f(gltype, color);
}
...
void gl4_1core_glColorP4ui(void *_glfuncs, GLenum gltype, GLuint color)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glColorP4ui"));
	_f(gltype, color);
}
...
void gl4_1core_glColorP3uiv(void *_glfuncs, GLenum gltype, const GLuint* color)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glColorP3uiv"));
	_f(gltype, color);
}
...
void gl4_1core_glColorP3ui(void *_glfuncs, GLenum gltype, GLuint color)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glColorP3ui"));
	_f(gltype, color);
}
...
void gl4_1core_glNormalP3uiv(void *_glfuncs, GLenum gltype, const GLuint* coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glNormalP3uiv"));
	_f(gltype, coords);
}
...
void gl4_1core_glNormalP3ui(void *_glfuncs, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glNormalP3ui"));
	_f(gltype, coords);
}
...
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glMultiTexCoordP4uiv"));
	_f(texture, gltype, coords);
}

void gl4_1core_glMultiTexCoordP4ui(void *_glfuncs, GLenum texture, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glMultiTexCoordP4ui"));
	_f(texture, gltype, coords);
}
...
void gl4_1core_glMultiTexCoordP3uiv(void *_glfuncs, GLenum texture, GLenum gltype, const GLuint* coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glMultiTexCoordP3uiv"));
	_f(texture, gltype, coords);
}
...
void gl4_1core_glMultiTexCoordP3ui(void *_glfuncs, GLenum texture, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glMultiTexCoordP3ui"));
	_f(texture, gltype, coords);
}
...
void gl4_1core_glMultiTexCoordP2uiv(void *_glfuncs, GLenum texture, GLenum gltype, const GLuint* coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glMultiTexCoordP2uiv"));
	_f(texture, gltype, coords);
}
...
void gl4_1core_glMultiTexCoordP2ui(void *_glfuncs, GLenum texture, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glMultiTexCoordP2ui"));
	_f(texture, gltype, coords);
}
...
void gl4_1core_glMultiTexCoordP1uiv(void *_glfuncs, GLenum texture, GLenum gltype, const GLuint* coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glMultiTexCoordP1uiv"));
	_f(texture, gltype, coords);
}
...
void gl4_1core_glMultiTexCoordP1ui(void *_glfuncs, GLenum texture, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glMultiTexCoordP1ui"));
	_f(texture, gltype, coords);
}
...
void gl4_1core_glTexCoordP4uiv(void *_glfuncs, GLenum gltype, const GLuint* coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glTexCoordP4uiv"));
	_f(gltype, coords);
}
...
void gl4_1core_glTexCoordP4ui(void *_glfuncs, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glTexCoordP4ui"));
	_f(gltype, coords);
}
...
void gl4_1core_glTexCoordP3uiv(void *_glfuncs, GLenum gltype, const GLuint* coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glTexCoordP3uiv"));
	_f(gltype, coords);
}
...
void gl4_1core_glTexCoordP3ui(void *_glfuncs, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glTexCoordP3ui"));
	_f(gltype, coords);
}
...
void gl4_1core_glTexCoordP2uiv(void *_glfuncs, GLenum gltype, const GLuint* coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glTexCoordP2uiv"));
	_f(gltype, coords);
}
...
void gl4_1core_glTexCoordP2ui(void *_glfuncs, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glTexCoordP2ui"));
	_f(gltype, coords);
}
...
void gl4_1core_glTexCoordP1uiv(void *_glfuncs, GLenum gltype, const GLuint* coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glTexCoordP1uiv"));
	_f(gltype, coords);
}
...
void gl4_1core_glTexCoordP1ui(void *_glfuncs, GLenum gltype, GLuint coords)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glTexCoordP1ui"));
	_f(gltype, coords);
}
...
void gl4_1core_glVertexP4uiv(void *_glfuncs, GLenum gltype, const GLuint* value)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glVertexP4uiv"));
	_f(gltype, value);
}
...
void gl4_1core_glVertexP4ui(void *_glfuncs, GLenum gltype, GLuint value)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glVertexP4ui"));
	_f(gltype, value);
}
...
void gl4_1core_glVertexP3uiv(void *_glfuncs, GLenum gltype, const GLuint* value)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glVertexP3uiv"));
	_f(gltype, value);
}
...
void gl4_1core_glVertexP3ui(void *_glfuncs, GLenum gltype, GLuint value)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glVertexP3ui"));
	_f(gltype, value);
}
...
void gl4_1core_glVertexP2uiv(void *_glfuncs, GLenum gltype, const GLuint* value)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, const GLuint*);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glVertexP2uiv"));
	_f(gltype, value);
}
...
void gl4_1core_glVertexP2ui(void *_glfuncs, GLenum gltype, GLuint value)
{
	// Not exposed by QOpenGLFunctions_* in Qt 6; resolve like Qt 5 did.
	typedef void (QOPENGLF_APIENTRYP _Fp)(GLenum, GLuint);
	static _Fp _f = reinterpret_cast<_Fp>(QOpenGLContext::currentContext()->getProcAddress("glVertexP2ui"));
	_f(gltype, value);
}
